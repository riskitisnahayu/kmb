...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <link rel="icon" type="image/png" href="kmb.ico">
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <div class="culmn">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#brand">
                            ...
                            <img src="images/kmb.png" class="logo logo-display m-top-10" alt="">
                            <img src="images/kmb.jpg" class="logo logo-scrolled" alt="">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                            <li><a href="#hello">Halo</a></li>
                            <li><a href="#about">Tentang</a></li>
                            <li><a href="#service">Pengurus</a></li>
            ...
            <section id="hello" class="home bg-mega" style="background: url({!! asset('images/banner.JPG') !!}) no-repeat bottom center; background-size: cover">
                <div class="overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="main_home">
                            <div class="home_text">
                                <h1 class="text-white">KOMUNITAS MAHASISWA BOYOLALI <br /> YOGYAKARTA</h1>
                            </div>

                            <div class="home_btns m-top-50">
                        ...
                        <div class="main_about">
                            <div class="col-md-6">
                                <div class="about_content">
                                    ...
                                    <p>Komunitas Mahasiswa Boyolali (KMB) merupakan perkumpulan mahasiswa yang berasal dari
                                        Boyolali yang berkuliah di Yogyakarta. Mereka bersalah dari berbagai universitas
                                        di Yogyakarta, baik Perguruan Tinggi Negeri maupun Perguruan Tinggi Swasta dengan
                                        berbagai jurusan. </p>
